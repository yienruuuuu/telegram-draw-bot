...
public class MainBotConsumer implements LongPollingSingleThreadUpdateConsumer {
    ...
    @Autowired
    public MainBotConsumer(BotRepository botRepository, AppConfig appConfig, CommandDispatcher commandDispatcher, CallbackDispatcher callbackDispatcher, ChannelPostHandler channelPostHandler) {
