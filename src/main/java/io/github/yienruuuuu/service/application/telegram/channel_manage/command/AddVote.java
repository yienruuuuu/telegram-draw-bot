...
@Slf4j
@Component
public class AddVote implements ChannelManageBotCommand {
    ...
    public AddVote(AppConfig appConfig, UserService userService, TelegramBotClient telegramBotClient, CheatCodeService cheatCodeService, AnnouncementService announcementService) {
