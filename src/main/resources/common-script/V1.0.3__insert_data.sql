INSERT INTO `tg_draw_bot`.`user` (`id`, `role`, `telegram_user_id`, `first_name`, `language_id`, `is_block`, `free_points`, `purchased_points`, `last_pick_rare_time`, `created_at`, `updated_at`) VALUES (1, 'MANAGER', '1513052214', 'Ru', 1, 0, 0, 0, NULL, '2024-11-14 06:58:32', '2024-11-14 06:58:48');
...
INSERT INTO `tg_draw_bot`.`resource` (`id`, `file_type`, `rarity_type`, `file_id_main_bot`, `file_id_manage_bot`, `tags`, `unique_id`, `has_been_card_before`, `created_at`, `updated_at`) VALUES (4, 'GIF', 'NORMAL', 'CgACAgUAAyEFAASR9m7DAAMZZzRaMIJDF4Mjx21WdkekAVnX8HYAAh4QAAK10ThWmduZjfPF0ek2BA', 'CgACAgUAAxkBAAOSZzWlau_qf11LedAWzI1QJRiROVkAAh4QAAK10ThWYUCfkw-2XxU2BA', NULL, 'AgADHhAAArXROFY', 0, '2024-11-14 07:23:23', '2024-11-14 07:23:24');
